  ...
  const worksInPreparation = [
    {
      ...
      authors: "Shrestha, R., Alessandri, R., Vögele, M., de Souza, P. C. T., Marrink, S., J., & Monticelli, L.",
      type: "preparation"
    },
    {
      title: "Martini Coarse-Grained Model for Graphene oxide",
      authors: "Shrestha, R., Hilpert, C., Cambiaso, S., Bochicchio, D., Rossi G ., & Monticelli, L.",
      type: "preparation"
    },
    {
      title: "Martini 3 coarse-grained model for chitosan with tunable acetylation",
      authors: "Cambiaso, S., Bochicchio, D., Shrestha, R., Rossi, & Monticelli, L.",
      type: "preparation"
    },
    {
      title: "Simulating membrane proteins in asymmetric membranes",
      authors: "Crespi Veronica, Shrestha, R., di Meo F, & Monticelli, L.",
      type: "preparation"
    }
  ];
