      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-slate-300 leading-relaxed">
              PhD Researcher in Computational Biophysics, specializing in molecular dynamics simulations 
              and computational modeling of biological systems and nanomaterials.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-slate-300">• Molecular Dynamics Simulations</div>
              <div className="text-slate-300">• Nanomaterial-Biomolecule Interactions</div>
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 text-center">
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="text-slate-300">© {currentYear} Roshan Shrestha. All rights reserved.</span>
          </div>
