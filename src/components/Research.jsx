...
import { Microscope, Target, Lightbulb, BookOpen, Atom, Dna, Zap } from 'lucide-react';
...
const Research = () => {
  const researchInterests = [
    { text: 'Computational modeling of biological systems', icon: <Dna className="w-5 h-5" /> },
    { text: 'Atomistic and coarse-grained molecular dynamics simulations', icon: <Atom className="w-5 h-5" /> },
    { text: 'Protein-lipid bilayer interactions', icon: <Microscope className="w-5 h-5" /> },
    { text: 'Free energy calculations (Umbrella Sampling, Metadynamics)', icon: <Zap className="w-5 h-5" /> },
    { text: 'Nanomaterial-biomolecule interactions', icon: <Target className="w-5 h-5" /> },
    { text: 'Polymers and Membrane Proteins', icon: <Lightbulb className="w-5 h-5" /> },
    { text: 'Data analysis for simulations (Python, NumPy, Matplotlib, Pandas)', icon: <BookOpen className="w-5 h-5" /> }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Exploring the frontiers of computational biophysics and molecular dynamics
          </p>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-blue-100/50">
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                I am a PhD student specializing in Computational Biophysics with a primary focus on the computational 
                modeling of biological systems and nanomaterials. My research aims to leverage advanced biophysical 
                training and molecular dynamics simulations to enhance our understanding of complex biological 
                interactions and the behavior of nanomaterials at the molecular level.
              </p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-green-100/50">
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 border border-green-200/50">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Currently, I am involved in a molecular dynamics study investigating the interactions between 
                  nanoparticles and Glycophorin-A. This collaborative project aims to elucidate the molecular 
                  mechanisms governing these interactions, which is crucial for understanding nanoparticle 
                  biocompatibility and potential biomedical applications.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="group bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-l-4 border-blue-500 hover:shadow-lg transition-all duration-300">
                <h3 className="text-xl font-semibold text-slate-900 mb-3 flex items-center">
                  ...
                  M.Sc. Research (Central Department of Physics, Tribhuvan University)
                </h3>
                <p className="text-slate-700 leading-relaxed">
                  My Master's research involved working on both atomistic and coarse-grained molecular dynamics 
                  simulations of proteins embedded in lipid bilayers. During this period, I acquired significant 
                  knowledge and practical skills in performing free energy calculations using methods such as 
                  umbrella sampling and enhanced collective variable sampling techniques like metadynamics. I also 
                  gained proficiency in data analysis using Python and its associated libraries (NumPy, Matplotlib, 
                  Pandas). My thesis focused on "A MOLECULAR DYNAMICS STUDY IN STRUCTURAL DYNAMICS OF A V717I 
                  SUBSTITUTION IN THE AMYLOID PRECURSOR PROTEIN."
                </p>
              </div>
              ...
              <div className="group bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-l-4 border-green-500 hover:shadow-lg transition-all duration-300">
                <h3 className="text-xl font-semibold text-slate-900 mb-3 flex items-center">
                  ...
                  Graduate Research Assistant (GCK's Computational Lab, Tribhuvan University)
                </h3>
                <p className="text-slate-700 leading-relaxed">
                  As a research assistant, I supported Bachelor's and Master's students in running Ab initio 
                  calculations and Molecular Dynamics Simulations, further solidifying my expertise in these 
